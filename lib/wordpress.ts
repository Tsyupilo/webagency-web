...
if (!lang) {
	throw new Error("Site language is not defined");
}
...
export async function getAllCategories(): Promise<Category[]> {
	return wordpressFetch<Category[]>("/wp-json/wp/v2/categories", { lang });
}
...
export async function getPostsByTag(tagId: number): Promise<Post[]> {
	return wordpressFetch<Post[]>("/wp-json/wp/v2/posts", { tags: tagId, lang });
}

export async function getTagsByPost(postId: number): Promise<Tag[]> {
	return wordpressFetch<Tag[]>("/wp-json/wp/v2/tags", { post: postId, lang });
}

export async function getAllTags(): Promise<Tag[]> {
	return wordpressFetch<Tag[]>("/wp-json/wp/v2/tags", { lang });
}
...
export async function getAllPages(): Promise<Page[]> {
	return wordpressFetch<Page[]>("/wp-json/wp/v2/pages", { lang });
}
...
export async function getPostsByTagSlug(tagSlug: string): Promise<Post[]> {
	...
	return wordpressFetch<Post[]>("/wp-json/wp/v2/posts", { tags: tag.id, lang });
}
...
export async function getHomePageData(): Promise<Page> {
