...
import { FilterPosts } from "@/components/blocks/posts/filter";
import { PostCard } from "@/components/blocks/posts/post-card";
import { SearchInput } from "@/components/blocks/posts/search-input";
import { Container, Prose, Section } from "@/components/craft";

import { postsHeadings } from "@/configs/posts.config";
    ...
    <Section>
      <Container>
        <div className="space-y-8">
          <Prose>
            <h2>{postsHeadings.allPosts[siteConfig.site_lang]}</h2>
          </Prose>
