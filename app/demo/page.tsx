...
// Icons
import { NextJsIcon } from "@/components/assets/icons/socials/nextjs";
import { WordPressIcon } from "@/components/assets/icons/socials/wordpress";
  ...
  return (
    <main className="space-y-6">
      ...
      <div className="mt-6 grid gap-4 md:grid-cols-3">
        <Link
          className="flex h-48 flex-col justify-between rounded-lg border bg-accent/50 p-4 transition-all hover:scale-[1.02]"
          href="/posts"
        >
          <Pen size={32} />
          <span>
